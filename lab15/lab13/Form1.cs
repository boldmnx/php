...
namespace lab13
{
    public partial class Form1 : Form
    {
        ...
        private void LoadBranches()
        {
            ...
            {
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter("SELECT sid, sname FROM t_salbar", con);
                DataTable dt = new DataTable();
                da.Fill(dt);


                DataRow row = dt.NewRow();
                row["sid"] = DBNull.Value; // эсвэл 0 гэх мэт default ID
                row["sname"] = "------";
        ...
        private void LoadData()
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("GetAllWorkers", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Жишээ нь: comboBox2 дээр салбарын нэрийг харуулж, value нь bid байна гэж үзье.
            int sid = Convert.ToInt32(comboBox2.SelectedValue); // t_salbar лавлах хүснэгтийн bid

            using (SqlConnection con = new SqlConnection(connectionString))
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("InsertWorker", con);
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            // Form-ыг цэвэрлэх хэсэг
            textBox1.Clear();
            textBox2.Clear();
            textBox3.Clear();
            comboBox1.SelectedIndex = -1;
            comboBox2.SelectedIndex = -1; // салбарын combobox
